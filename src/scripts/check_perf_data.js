...
function checkData() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log('Checking analytics_complex for performance_vs_tenure...');
                    return [4 /*yield*/, supabase
                            .from('analytics_complex')
                            .select('*', { count: 'exact' })
                            .eq('chart_id', 'performance_vs_tenure')];
                case 1:
                    ...
                    if (error) {
                        ...
                        console.log("Found ".concat(count, " records."));
                        if (data && data.length > 0) {
                            console.log('Sample record:', JSON.stringify(data[0], null, 2));
                        }
                        else {
                            console.log('No data found. Seeding logic might have been skipped.');
                        }
                    }
                    return [2 /*return*/];
            }
